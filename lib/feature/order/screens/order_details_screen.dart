    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          bool showDeliveryConfirmImage = orderController
          ...
          if (controllerOrderModel != null) {
            showBottomView = controllerOrderModel.orderStatus == 'accepted' ||
                    ...
                    child: Column(children: [
                      ...
                      InfoCardWidget(
                        ...
                        image: controllerOrderModel.customer != null
                            ? '${controllerOrderModel.customer!.image}'
                            : '',
                      ...
                      Column(
                          ...
                          children: [
                            ...
                            (controllerOrderModel.orderNote != null &&
                                ...
                                : const SizedBox(),
                            (controllerOrderModel.orderStatus == 'delivered' &&
                                    controllerOrderModel.orderProof != null &&
                                    controllerOrderModel.orderProof!.isNotEmpty)
                                ? Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                onTap: () => openDialog(context,
                                                    '${controllerOrderModel.orderProof![index]}'),
                                                child: Center(
                                                    child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
